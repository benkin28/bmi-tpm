...
nele = 31 # number of rbfs -1 in each dimension for \eta_i(s)
shapeFuncsDim = 16 # number of rbfs in each dimension for \w_j(s)
reducedDim = 17 # \sqrt{dimX}
createNewCondField = True # True if you want to create a new conductivity field dataset
saveDatasetOption = False # True if you want to save the dataset at the location below
importDatasetOption = False# True if you want to import the dataset from the location below
saveModelOption = True # True if you want to save the model at ./utils/trainedNNs/
...
IterSvi = 7000 # Number of SVI iterations (Stochastic Variation Optimization) At least 7000/9000 for ttraining
...
saveFileName="24CR10FR50D0" # Name of the file to save the modelutils/trainedNNs/trainedCGdim24CR10FR50D0.pth
# Path of the dataset
